...
So now we have made sure that only authorized users (ie. us) can add, edit or publish posts. Now we want to make sure a login button appears for everybody else.
